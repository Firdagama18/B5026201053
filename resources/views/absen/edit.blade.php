            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <div class="input-group date" id="datetimepicker">
                      <input type="text" class="form-control" name="tanggal" value="{{ $p->Tanggal}}" required = "required">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="hadir" name="status" value="H" @if ($p->status === "T") checked="checked" @endif required>
