...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
                <div class="img bg-wrap text-center" style="margin-top:35px" >
                    <img src="{{URL::asset('/images/fotoFirda.jpeg')}}" class="img-fluid rounded-circle mt-1" alt="profile Pic" width="50%">
                    <h5 class="text-light mt-3">Firdaus Wahyu Gama Ashaari</h5>
                    <h6 class="text-light">5026201053</h6>

	        <ul class="list-unstyled components mb-5" style="margin-top:35px">
	          <li>
